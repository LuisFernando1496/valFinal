...
*/
        ...
        .es-wrapper {
            ...
            background-image: url('https://valparaiso.ventitux.com/public/img/bg-email2.jpg');
        }
...
<body>
   ...
   <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
    <v:fill type="tile" src="https://valparaiso.ventitux.com/public/img/bg-email.jpg" color="#223748" origin="0.5, 0" position="0.5, 0"></v:fill>
   </v:background>
  <![endif]-->
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            background="https://valparaiso.ventitux.com/public/img/bg-email2.jpg"
                                                                                    ...
                                                                                    <td align="center"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            ...
                                                                                            <img class="adapt-img esdev-empty-img"
                                                                                                src="https://valparaiso.ventitux.com/public/img/logo_val-n.png?v2"
                                                                                                alt width="300px">
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
